...
const HeroSection = () => {
  return (
    <section 
      ...
      style={{ 
        backgroundImage: "linear-gradient(rgba(26, 46, 68, 0.7), rgba(26, 46, 68, 0.7)), url('https://images.unsplash.com/photo-1592549585866-486f41343aaf?q=80&w=2670&auto=format&fit=crop')",
      }}
    >
